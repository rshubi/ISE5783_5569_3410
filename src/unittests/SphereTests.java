...
class SphereTests {
	...
	public void testFindIntersections() {
		...
		// TC12:Ray starts inside the sphere (before the center)and passes through the center of the sphere  (1 points)
		...
		// TC13:Ray starts before the sphere and passes through the center of the sphere (2 points)
		...
		assertEquals(List.of(p6), result, "Ray crosses sphere");
		// Group2:2 tests
		// TC17:Ray starts at sphere and goes inside but does not pass through the center of the sphere
		...
		assertNull(sphere.findIntersections(new Ray(new Point(1, 0, 1), new Vector(-1, 0, 0))),"TC19 FAILED:Wrong number of points");
		// TC20:Ray starts before the tangent point
		assertNull(sphere.findIntersections(new Ray(new Point(3, 0, 1), new Vector(1, 0, 0))),"TC20 FAILED:Wrong number of points");
		// TC21:Ray starts after the tangent point
		assertNull(sphere.findIntersections( new Ray(new Point(1, 1, 1), new Vector(-0.5, 0, 0))),"TC21 FAILED:Wrong number of points");
