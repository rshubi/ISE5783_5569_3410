...
class VectorTests {
	...
	void testLength() {
		...
		// zero vector
		assertThrows(IllegalArgumentException.class, () -> isZero(new Vector(0, 0, 0).length()),
	...
	void testNormalize() {
		...
		assertThrows(IllegalArgumentException.class, () -> isZero(new Vector(0, 0, 0).normalize().length()),
