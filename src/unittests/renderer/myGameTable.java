...
class myGameTable {
	...
	public void test() {
		...
		scene.geometries.add(
				...
				new Plane(new Point(200,-1000,0),new Point(30,1000,0),new Point(0,0,100)).setEmission(new Color(0,0,0)).setMaterial(new Material().setnShininess(100).setkR(1)),
				
				new Triangle(new Point(0, 55, 0),new Point(30,200,0), new Point(-30,200,0)).setEmission(new Color(0, 153, 0))
				.setMaterial(new Material().setKd(0.5).setKs(0.5).setkT(0).setnShininess(60)),
				
				new Triangle(new Point(-68,68,0),new Point(-8,98,0), new Point(-14,127,0)).setEmission(new Color(0, 153, 0))
				.setMaterial(new Material().setKd(0.5).setKs(0.5).setkT(0).setnShininess(60)),
				
				new Triangle(new Point(68,68,0),new Point(14,127,0), new Point(8,98,0)).setEmission(new Color(0, 153, 0))
				.setMaterial(new Material().setKd(0.5).setKs(0.5).setkT(0).setnShininess(60))
		);
		scene.lights.add(new SpotLight(new Color(700, 400, 400),new Point(20,30,0), new Vector(-1, 1, 4))
				.setKc(1).setKl(4E-4).setKq(2E-5));
		scene.lights.add(new SpotLight(new Color(700, 400, 400),new Point(40,-40,-20), new Vector(-2, 3, 3))
				.setKc(1).setKl(4E-4).setKq(2E-5));
